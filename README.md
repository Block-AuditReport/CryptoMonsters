...
// File: @openzeppelin/contracts/utils/Context.sol // SPDX-License-Identifier: MIT
...
amount. */ function burnFrom(address account, uint256 amount) public virtual { uint256 currentAllowance = allowance(account, _msgSender()); require(currentAllowance >= amount, "ERC20: burn amount exceeds allowance"); unchecked { _approve(account, _msgSender(), currentAllowance - amount); } _burn(account, amount); } }
...
contract CTRAIN is ERC20, ERC20Burnable, Ownable { constructor() ERC20("Cryptotrains", "CTRAIN") { _mint(msg.sender, 100000000 * 10 ** decimals()); } }
